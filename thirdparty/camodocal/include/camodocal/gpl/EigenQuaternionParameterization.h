...
{
public:
    virtual ~EigenQuaternionManifold() {}
...
using EigenQuaternionParameterization = EigenQuaternionManifold;

template<typename T>
void
EigenQuaternionManifold::EigenQuaternionProduct(const T z[4], const T w[4], T zw[4]) const
{
